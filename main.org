...
Changes to be committed:
  (use "git restore --staged <file>..." to unstage)
	modified:   .gitignore
	modified:   main.org
	new file:   make_latent.py
	new file:   new/train_flux_lora_deepspeed.org
...
#+RESULTS:
: [aravind_prodigy_dataset 3e64e3d] Started working on latent caching
:  4 files changed, 948 insertions(+), 12 deletions(-)
:  create mode 100644 make_latent.py
:  create mode 100644 new/train_flux_lora_deepspeed.org
